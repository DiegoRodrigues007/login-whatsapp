...
export default ({ user }) => {
  ...
  const [list, setList] = useState([
    ...
    { author: 147, body: "bla bla bla bla bla" },
    { author: 123, body: "hahahahaha" },
    { author: 123, body: "bla bla " },
    { author: 147, body: "bla bla bla bla bla" },
    { author: 123, body: "hahahahaha" },
    ...
    {
      author: 123,
      body: "bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla bla ",
    },
    {
      author: 147,
      body: "bla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla blabla bla bla bla bla",
    },
  ]);
